...
export default function CityCanvas({ onBuildingClick, onCursorBig }: CityCanvasProps) {
  ...
  return (
    <div id="stage" className="fixed inset-0 w-full h-full">
      ...
      {/* Hint */}
      <div
        className="absolute bottom-[5.5%] left-1/2 -translate-x-1/2 text-[0.72rem] text-white/50 tracking-[0.18em] uppercase z-[5] pointer-events-none text-center leading-[1.8]"
